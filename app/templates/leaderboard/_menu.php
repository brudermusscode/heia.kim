...
<inline-navigator fl fldircol gap=smoler>
  <a href="<?= "$base_url/osu/vanilla"; ?>" sub fl alic jucsb <?php if ($country !== "squads") echo "active"; ?>>
    <div>
  ...
  <a href="<?= "$base_url/osu/vanilla/performance/squads"; ?>" sub fl alic jucsb <?php display_active($country, "squads"); ?>>
    <div>
