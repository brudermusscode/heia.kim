...
<tipp-box outlined rounded="mid">
  <mi>info</mi>
  <p text=""><?= APP_NAME; ?> will occasionally send you e-mails with notifications about activities of you
    and other public players,
    ending subscriptions or newsletters which you can unsubscribe from here.</p>
</tipp-box>

<form request="user:settings:privacy:update" delay="20" radio responder=error no-loader fl fldircol gap=smol>
  <box-model p32 filled>
