...
?>
    ...
    <box-model user-graph outlined posrel rounded=mid fl alic jucc style=height:242px;>
      <div fl alic jucc fldircol gap=smol+ slight>
        <div style=height:3.2em;width:3.2em; filled=ligter fl jucc alic circled>
          <mi wide>process_chart</mi>
        </div>
        <p tac>No ranking data</p>
      </div>
    </box-model>
