...
<?php if (!$is_me) { ?>
  <div relationship-actions <?= $is_following ? "unfollow" : "follow"; ?> z>
    <mbutton has-tooltip=bottom follow background=follow color=dark-green ripple-effect icon-only
      data-action="relationships:create"
      data-user-id="<?= $ThisUser->id; ?>">
      <mi>add</mi>
      <div ttooltip>
    ...
    <mbutton has-tooltip=bottom unfollow ripple-effect background=unfollow color=dark-red icon-only
    ...
    <mbutton has-tooltip=bottom refollow background=refollow color=dark-blue icon-only
      data-action="relationships:create"
      data-user-id="<?= $ThisUser->id; ?>">
