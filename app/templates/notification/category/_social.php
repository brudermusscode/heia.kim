...
foreach ($Notifications as $Notification) {
  ...
  if ($main_type == "__relationship__") {
    $count++;
    include dirname(__DIR__) . "/type/_relationship.php";
  }

  if ($main_type == "__feedback__") {
    $count++;
    include dirname(__DIR__) . "/type/_feedback.php";
  }

  if ($main_type == "__comment__") {
    $count++;
    include dirname(__DIR__) . "/type/_comment.php";
  }
}
