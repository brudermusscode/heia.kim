...
class Application
{
  ...
  /**
   * Available themes to show the website in. This will be saved
   * in a cookie for the users client to remember it.
   *
   * @var array
   */
  ...
  /**
   * The current theme of the client.
   *
   * @var string
   */
  ...
  /**
   * The main theme to set, when no theme or an invalid one is set.
   *
   * @var string
   */
  public $main_theme;
  ...
  /**
   * Whether or not the dark mode for the current theme is enabled.
   *
   * @var boolean
   */
  ...
  public static function get_default_dialogues()
  {
    ...
    return [
      ...
      "TRY_OR_STAFF" =>
      "Try again. If the error persists, $discord_link_channel",

      "NEED_HELP" =>
      "If you need help, $discord_link_channel",

      "THINK_MISTAKE" =>
      "If you think this is a mistake, $discord_link_channel",

      "UNAVAILABLE_ASK_SUPPORT" =>
      "If it's not there, $discord_link_channel",

      "ONLY_STAFF" =>
      "Please open a support ticket on our <a extern target='_blank' href='" . $env->DISCORD_INVITE . "'>Discord &#160; <i class='ri-link-unlink'></i></a> using the '# Support'-channel and tell us where this error happened.",

      "ONE_USER_POLICY" =>
      $env->APP_NAME . " follows a one account per human policy. If you have signed up already, you are risking to get restricted in your gameplay.",

      "SUPPORT_US" =>
      "Consider supporting " . $env->APP_NAME . " and get some more!",

      "INVALID_REQUEST" =>
      "<strong>An invalid request has been sent to the client.</strong> If you keep seeing this error, $discord_link_channel",
      ...
      "SOCIALLY_EXCLUDED"
      => "<strong>You can't interact with the community at the moment.</strong>",

      "SOCIALLY_EXCLUDED_THIRD"
      => "<strong>This player can't interact with the community at the moment.</strong> Wait for them to get reintegrated.",
      ...
      "NO_PREMIUM_BUY" =>
      "<strong>You are not a Premium+ member!</strong> <a data-action=\"popup:open\" data-href=\"/user/buy-premium\">Unlock it now &#160; <i class='ri-link-unlink'></i></a>",
